...
**YOU ARE IN: `beads/polecats/amber/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/amber
```
...
**Your mail address:** `beads/polecats/amber`
**Your rig:** beads
...
1. Announce: "Polecat amber, checking in."
2. Run: `gt prime`
