...
**YOU ARE IN: `beads/polecats/agate/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/agate
```
...
**Your mail address:** `beads/polecats/agate`
**Your rig:** beads
...
1. Announce: "Polecat agate, checking in."
2. Run: `gt prime`
