...
**YOU ARE IN: `beads/polecats/malachite/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/malachite
```
...
**Your mail address:** `beads/polecats/malachite`
**Your rig:** beads
...
1. Announce: "Polecat malachite, checking in."
2. Run: `gt prime`
