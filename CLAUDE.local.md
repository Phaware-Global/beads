...
**YOU ARE IN: `beads/polecats/pearl/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/pearl
```
...
**Your mail address:** `beads/polecats/pearl`
**Your rig:** beads
...
1. Announce: "Polecat pearl, checking in."
2. Run: `gt prime`
