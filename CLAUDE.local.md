...
**YOU ARE IN: `beads/polecats/sapphire/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/sapphire
```
...
**Your mail address:** `beads/polecats/sapphire`
**Your rig:** beads
...
1. Announce: "Polecat sapphire, checking in."
2. Run: `gt prime`
