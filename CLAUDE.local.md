...
**YOU ARE IN: `beads/polecats/pyrite/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/pyrite
```
...
**Your mail address:** `beads/polecats/pyrite`
**Your rig:** beads
...
1. Announce: "Polecat pyrite, checking in."
2. Run: `gt prime`
