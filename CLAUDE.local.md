...
**YOU ARE IN: `beads/polecats/amethyst/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/amethyst
```
...
**Your mail address:** `beads/polecats/amethyst`
**Your rig:** beads
...
1. Announce: "Polecat amethyst, checking in."
2. Run: `gt prime`
