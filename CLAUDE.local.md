...
**YOU ARE IN: `beads/polecats/turquoise/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/turquoise
```
...
**Your mail address:** `beads/polecats/turquoise`
**Your rig:** beads
...
1. Announce: "Polecat turquoise, checking in."
2. Run: `gt prime`
