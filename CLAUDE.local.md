...
**YOU ARE IN: `beads/polecats/diamond/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/diamond
```
...
**Your mail address:** `beads/polecats/diamond`
**Your rig:** beads
...
1. Announce: "Polecat diamond, checking in."
2. Run: `gt prime`
