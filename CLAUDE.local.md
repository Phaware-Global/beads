...
**YOU ARE IN: `beads/polecats/emerald/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/emerald
```
...
**Your mail address:** `beads/polecats/emerald`
**Your rig:** beads
...
1. Announce: "Polecat emerald, checking in."
2. Run: `gt prime`
