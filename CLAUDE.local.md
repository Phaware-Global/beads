...
**YOU ARE IN: `beads/polecats/lapis/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/lapis
```
...
**Your mail address:** `beads/polecats/lapis`
**Your rig:** beads
...
1. Announce: "Polecat lapis, checking in."
2. Run: `gt prime`
