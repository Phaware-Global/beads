...
**YOU ARE IN: `beads/polecats/granite/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/granite
```
...
**Your mail address:** `beads/polecats/granite`
**Your rig:** beads
...
1. Announce: "Polecat granite, checking in."
2. Run: `gt prime`
